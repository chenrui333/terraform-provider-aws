...
check "schema_docs" {
  ...
  ignore_targets = [
    ...
    "data_source/aws_cloudformation_export",
    "data_source/aws_cloudformation_stack",
    "data_source/aws_cloudformation_type",
    "data_source/aws_cloudfront_cache_policy",
    ...
    "data_source/aws_cloudfront_origin_access_control",
    ...
    "data_source/aws_cloudtrail_service_account",
    "data_source/aws_cloudwatch_contributor_managed_insight_rules",
    "data_source/aws_cloudwatch_event_bus",
    "data_source/aws_cloudwatch_event_buses",
    "data_source/aws_cloudwatch_event_connection",
    "data_source/aws_cloudwatch_event_source",
    "data_source/aws_cloudwatch_log_data_protection_policy_document",
    "data_source/aws_cloudwatch_log_group",
    "data_source/aws_cloudwatch_log_groups",
    "data_source/aws_codeartifact_authorization_token",
    "data_source/aws_codeartifact_repository_endpoint",
    "data_source/aws_codebuild_fleet",
    "data_source/aws_codecatalyst_dev_environment",
    "data_source/aws_codecommit_approval_rule_template",
    "data_source/aws_codecommit_repository",
    "data_source/aws_codeguruprofiler_profiling_group",
    "data_source/aws_codestarconnections_connection",
    "data_source/aws_cognito_identity_pool",
    "data_source/aws_cognito_user_group",
    "data_source/aws_cognito_user_groups",
    "data_source/aws_cognito_user_pool_client",
    "data_source/aws_cognito_user_pool",
    "data_source/aws_cognito_user_pools",
    "data_source/aws_connect_bot_association",
    "data_source/aws_connect_contact_flow_module",
    "data_source/aws_connect_contact_flow",
    "data_source/aws_connect_hours_of_operation",
    "data_source/aws_connect_instance_storage_config",
    ...
    "data_source/aws_connect_security_profile",
    "data_source/aws_connect_user_hierarchy_group",
    "data_source/aws_connect_user_hierarchy_structure",
    "data_source/aws_connect_user",
    "data_source/aws_connect_vocabulary",
    "data_source/aws_controltower_controls",
    "data_source/aws_cur_report_definition",
    ...
    "data_source/aws_docdb_engine_version",
    "data_source/aws_docdb_orderable_db_instance",
    "data_source/aws_dx_connection",
    ...
    "data_source/aws_ecr_image",
    "data_source/aws_ecr_images",
    "data_source/aws_ecr_lifecycle_policy_document",
    "data_source/aws_ecr_pull_through_cache_rule",
    "data_source/aws_ecr_repositories",
    "data_source/aws_ecr_repository_creation_template",
    ...
    "data_source/aws_iam_role",
    "data_source/aws_iam_roles",
    "data_source/aws_iam_saml_provider",
    "data_source/aws_iam_server_certificate",
    "data_source/aws_iam_user_ssh_key",
    "data_source/aws_iam_user",
    "data_source/aws_iam_users",
    "data_source/aws_identitystore_group_memberships",
    ...
    "data_source/aws_inspector_rules_packages",
    ...
    "data_source/aws_lb_trust_store",
    "data_source/aws_lb",
    "data_source/aws_lbs",
    "data_source/aws_lex_bot",
    ...
    "data_source/aws_memorydb_subnet_group",
    "data_source/aws_memorydb_user",
    "data_source/aws_msk_bootstrap_brokers",
    "data_source/aws_msk_broker_nodes",
    "data_source/aws_msk_cluster",
    "data_source/aws_msk_configuration",
    "data_source/aws_msk_kafka_version",
    "data_source/aws_msk_vpc_connection",
    "data_source/aws_mskconnect_connector",
    "data_source/aws_mskconnect_custom_plugin",
    "data_source/aws_mskconnect_worker_configuration",
    "data_source/aws_nat_gateway",
    "data_source/aws_nat_gateways",
    "data_source/aws_neptune_engine_version",
    "data_source/aws_neptune_orderable_db_instance",
    ...
    "data_source/aws_organizations_organizational_unit",
    "data_source/aws_organizations_organizational_units",
    "data_source/aws_organizations_policies_for_target",
    "data_source/aws_organizations_policies",
    "data_source/aws_organizations_policy",
    "data_source/aws_organizations_resource_tags",
    "data_source/aws_outposts_assets",
    "data_source/aws_outposts_outpost_instance_type",
    ...
    "data_source/aws_redshift_orderable_cluster",
    "data_source/aws_redshift_producer_data_shares",
    "data_source/aws_redshift_subnet_group",
    "data_source/aws_redshiftserverless_credentials",
    "data_source/aws_redshiftserverless_namespace",
    "data_source/aws_redshiftserverless_workgroup",
    "data_source/aws_region",
    "data_source/aws_regions",
    "data_source/aws_resourceexplorer2_search",
    ...
    "data_source/aws_route53_resolver_firewall_config",
    "data_source/aws_route53_resolver_firewall_domain_list",
    "data_source/aws_route53_resolver_firewall_rule_group_association",
    "data_source/aws_route53_resolver_firewall_rule_group",
    "data_source/aws_route53_resolver_firewall_rules",
    ...
    "data_source/aws_serverlessapplicationrepository_application",
    "data_source/aws_service_discovery_dns_namespace",
    "data_source/aws_service_discovery_http_namespace",
    "data_source/aws_service_discovery_service",
    "data_source/aws_service_principal",
    "data_source/aws_service",
    "data_source/aws_servicecatalog_constraint",
    "data_source/aws_servicecatalog_launch_paths",
    "data_source/aws_servicecatalog_portfolio_constraints",
    "data_source/aws_servicecatalog_portfolio",
    "data_source/aws_servicecatalog_product",
    "data_source/aws_servicecatalog_provisioning_artifacts",
    "data_source/aws_servicecatalogappregistry_application",
    "data_source/aws_servicecatalogappregistry_attribute_group_associations",
    ...
    "data_source/aws_spot_datafeed_subscription",
    "data_source/aws_sqs_queue",
    "data_source/aws_sqs_queues",
    "data_source/aws_ssm_document",
    "data_source/aws_ssm_instances",
    "data_source/aws_ssm_maintenance_windows",
    "data_source/aws_ssm_parameter",
    "data_source/aws_ssm_parameters_by_path",
    "data_source/aws_ssm_patch_baseline",
    "data_source/aws_ssm_patch_baselines",
    "data_source/aws_ssmcontacts_contact_channel",
    "data_source/aws_ssmcontacts_contact",
    "data_source/aws_ssmcontacts_plan",
    "data_source/aws_ssmcontacts_rotation",
    "data_source/aws_ssmincidents_replication_set",
    "data_source/aws_ssmincidents_response_plan",
    "data_source/aws_ssoadmin_application_assignments",
    "data_source/aws_ssoadmin_application_providers",
    "data_source/aws_ssoadmin_permission_set",
    "data_source/aws_ssoadmin_principal_application_assignments",
    "data_source/aws_storagegateway_local_disk",
    ...
    "data_source/aws_wafv2_rule_group",
    "data_source/aws_wafv2_web_acl",
    "data_source/aws_workspaces_bundle",
